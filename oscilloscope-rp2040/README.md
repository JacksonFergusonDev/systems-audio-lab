...
*A more informational version of the schematic, along with an explanation of the circuit, can be found in the [schematic documentation](./schematics/README.md).*
